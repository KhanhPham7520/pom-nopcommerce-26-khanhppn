...
public class HomePageObject extends AbstractPages {
    ...
    public void clickAddToCompareList(String productName) {
        // String typeButton = "Add to compare list";
        waitToElementClickable(driver, ProductPageUI.BUTTON, productName);
        clickToElement(driver, ProductPageUI.BUTTON, productName);
    }
