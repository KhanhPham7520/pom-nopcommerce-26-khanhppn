...
public class HomePageUI extends AbstractNopCommercePageUI {
    ...
    public static final String PRODUCT_LINK = "//h2[@class='product-title']//a";
    public static final String ADD_TO_COMPARISON_SUCCESS_MSG = "//div[@class='bar-notification success']";
}
